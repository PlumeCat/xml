...
namespace parse
{
    struct Rule
    {
        vector<Rule> alternates;
    };
    struct SymbolRule : public Rule
    {

    };
    struct StringRule : public Rule
    {

    };
    struct RangeRule : public Rule
    {
    ...
    struct OptionalRule : public Rule
    {

    };
    struct SequenceRule : public Rule
    {

    };

    void parse_rule_expression(const string& rule)
    {
